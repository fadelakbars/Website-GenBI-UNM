        ...
        <div class="container border-top-generic">
            <div class="row">
                <div class="col-md-12 center-content mb-30">
                    <h1 class="text-black">Daftar Mahasiswa Penerima Beasiswa Bank Indonesia Tahun 2024</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="img-text ">
                        <img src="img/video-bg.jpg" alt="" class="img-fluid float-left mr-20 mb-20">
                    </div>
                </div>
